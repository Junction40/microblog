...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        # flash message regardless if user's email is in the database so that even if they aren't registered they cannot find out if the email is registered
